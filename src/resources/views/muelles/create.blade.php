        ...
        <form action="{{ route('admin.muelles.store') }}" method="POST">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" class="form-control" required 
                           value="{{ old('nombre') }}" placeholder="Nombre identificativo">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="codigo" name="codigo" class="form-control" required 
                           value="{{ old('codigo') }}" placeholder="Ej: MCA-01">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <select id="tipo_muelle" name="tipo_muelle" class="form-control" required>
                        ...
                        <option value="contenedores" {{ old('tipo_muelle') == 'contenedores' ? 'selected' : '' }}>Contenedores</option>
                        <option value="carga_general" {{ old('tipo_muelle') == 'carga_general' ? 'selected' : '' }}>Carga General</option>
                        <option value="graneles" {{ old('tipo_muelle') == 'graneles' ? 'selected' : '' }}>Graneles</option>
                        <option value="pesquero" {{ old('tipo_muelle') == 'pesquero' ? 'selected' : '' }}>Pesquero</option>
                        <option value="pasajeros" {{ old('tipo_muelle') == 'pasajeros' ? 'selected' : '' }}>Pasajeros</option>
                        <option value="ro-ro" {{ old('tipo_muelle') == 'ro-ro' ? 'selected' : '' }}>Ro-Ro</option>
                        <option value="hidrocarburos" {{ old('tipo_muelle') == 'hidrocarburos' ? 'selected' : '' }}>Hidrocarburos</option>
                        <option value="deportivo" {{ old('tipo_muelle') == 'deportivo' ? 'selected' : '' }}>Deportivo</option>
                        <option value="servicios" {{ old('tipo_muelle') == 'servicios' ? 'selected' : '' }}>Servicios</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group-grid">
                    ...
                    <label class="checkbox-item">
                        <input type="checkbox" name="grua_disponible" value="1" {{ old('grua_disponible') ? 'checked' : '' }}>
                        <span>Grúa Disponible</span>
                    </label>
                    <label class="checkbox-item">
                        <input type="checkbox" name="energia_tierra" value="1" {{ old('energia_tierra') ? 'checked' : '' }}>
